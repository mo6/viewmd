...
Viewing anything in a terminal — a single document (a file, stdin, or a directory's `_Index.md`),
a directory listing with no `_Index.md`, or more than one path at once — pages into viewmd's own
